    ...
    public function create_produk(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            Produk::insert([
                ...
                'jenis_kepemilikan'    => $request->get("jenis_kepemilikan"),
                'luas_tanah'    => $request->get("luas_tanah"),
                'luas_bangunan'    => $request->get("luas_bangunan"),
                'akses_trdkt'    => $request->get("akses_trdkt"),
                'row_jalan'    => $request->get("row_jalan"),
                'tanggal_lelang' => $request->get("tanggal_lelang"),
                'jenis_jual' => $request ->get("jenis_jual"),
    ...
    public function update_produk(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $produkdb->update([
                ...
                'row_jalan'    => $request->get("row_jalan"),
                'tanggal_lelang' => $request->get("tanggal_lelang"),
                'jenis-jual' => $request->get("jenis_jual"),
